# Generated by Powerlevel10k configuration wizard on 2024-07-19 at 09:41 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    direnv                  # direnv status (hOS_ICON_CONTENT_EXPANSIONttps://direnv.net/)
  ...
  # Default current directory foreground clor.
